      ...
      <header className="relative bg-slate-900 text-white overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4 py-16 md:py-24 max-w-5xl text-center">
          ...
          <h1 className="text-4xl md:text-6xl font-extrabold tracking-tight mb-6 leading-tight">
            Stop Buying <span className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-200 to-yellow-500">'Pretty' Plans</span> That <br className="hidden md:block" /> Fail Inspection.
          </h1>
          
          <p className="text-lg md:text-2xl text-slate-300 mb-10 max-w-3xl mx-auto leading-relaxed">
            Get 30 Professional, Engineer-Stamped Tiny House Designs. Approved for wind loads, seismic zones, and structural integrity.
          </p>
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center">
            ...
            >
              Get the Architect Bundle for $17
        ...
        <div className="container relative z-10 mx-auto px-4">
          <div className="max-w-lg mx-auto bg-white text-slate-900 rounded-2xl shadow-2xl overflow-hidden transform hover:scale-105 transition-transform duration-300 ring-4 ring-safety-orange/20">
            ...
            <div className="p-8">
              ...
              <button className="w-full bg-safety-orange hover:bg-safety-orange-hover text-white text-xl font-bold py-4 rounded-lg shadow-lg flex items-center justify-center gap-2 group transition-colors mb-4">
